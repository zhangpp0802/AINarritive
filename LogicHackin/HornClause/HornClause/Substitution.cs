...
namespace HornClause
{
    ...
    public class Substitution
    {
        ...
        public Substitution(Variable variable, object value, Substitution next)
        {
            Variable = variable;
            Value = value;
            Next = next;
        ...
        public static bool Lookup(Substitution substitution, Variable variable, out object value)
        {
            while (substitution != null)
            {
                if (variable.Equals(substitution.Variable))
                {
